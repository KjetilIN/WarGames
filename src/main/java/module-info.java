module no.ntnu.wargames{
    ...
    opens no.ntnu.wargames.frontend.gui.dialog.complexDialog;
    opens no.ntnu.wargames.frontend.gui.dialog.simpleDialog;
    opens no.ntnu.wargames.frontend.gui.dialog;
